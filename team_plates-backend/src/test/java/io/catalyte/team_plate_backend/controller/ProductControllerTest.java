...
//	All Products Good
	...
	public void testGetAllProducts() throws Exception {
		this.mockMvc.perform(get("/products/all_products"))
		.andExpect(status().isOk());
	}
	
	@Test
	public void testGetAllProductsByDemographic() throws Exception {
		this.mockMvc.perform(get("http://localhost:8080/products/all_product_demographic?demographic=men"))
		.andExpect(status().isOk());
	}
	
	@Test
	public void testGetAllProductsByDemographicAndCategory() throws Exception {
		this.mockMvc.perform(get("http://localhost:8080/products/all_product_category?demographic=kids&category=athletic"))
		.andExpect(status().isOk());
		}
	
	@Test
	public void testGetAllProductsByDemographicAndType() throws Exception {
		this.mockMvc.perform(get("http://localhost:8080/products/all_product_type?demographic=kids&type=shoe"))
		.andExpect(status().isOk());
		}
	...
	@Test
	public void testGetNewProductsByDemographicAndCategory() throws Exception {
		this.mockMvc.perform(get("/products/new/category/men/formal"))
		.andExpect(status().isOk())
		.andExpect(jsonPath("$", hasSize(2)));
	}
	...
	public void testSadGetNewPurchases() throws Exception {
		this.mockMvc.perform(get("/products/neww"))
		.andExpect(status().isNotFound());
	}
	...
	@Test
	public void testSadGetNewProductsByDemographicAndCategory() throws Exception {
		this.mockMvc.perform(get("/products/new/category/men/ugly"))
		.andExpect(status().isOk())
		.andExpect(jsonPath("$", hasSize(0)));
	}
