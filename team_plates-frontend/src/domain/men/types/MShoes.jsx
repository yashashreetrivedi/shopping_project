...
class MShoes extends Component {

	componentDidMount() {
		this.props.dispatch(ProductsActions.getNewProductsDemographicType('men', 'shoe'));
		this.props.dispatch(ProductsActions.getPopularProductsDemoTypeSaga('men', 'shoe'));
		this.props.dispatch(ProductsActions.getAllProductsDemographicAndTypeSaga('men', 'shoe'));
